...
public class prg {
    ...
    public prg() {
        ...
        quizQuestions.add(new Question("What is the capital of France?", List.of("A. Berlin", "B. Paris", "C. Madrid", "D. Rome"), 1));
        quizQuestions.add(new Question("Which programming language is used for Android app development?", List.of("A. Java", "B. Python", "C. C++", "D. Ruby"), 0));
    ...
    private void getUserAnswer() {
        ...
        if (userAnswer.equals(getOptionLetter(currentQuestion.getCorrectOptionIndex()))) {
            ...
            System.out.println("Incorrect. The correct answer was: " + getOptionLetter(currentQuestion.getCorrectOptionIndex()));
        }
